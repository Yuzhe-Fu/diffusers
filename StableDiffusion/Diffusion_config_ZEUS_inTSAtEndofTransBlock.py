...
GLOBAL_TIMESTEP_SKIP_STATE = {
    ...
    'current_step': 0,
    'skip_steps': [2, 44, 4],  # Number of initial steps to keep normal computation
...
def update_mask(top_k):
    ...
    # mask = torch.zeros_like(meanabs_1d)
    # mask[topk_indices] = 1.0
    # mask = mask.unsqueeze(0).unsqueeze(-1).expand_as(noise_pred)
