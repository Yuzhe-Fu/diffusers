...
def patch_unet_transformer_block(block_class: Type[torch.nn.Module], mode: str = 'token_merge') -> Type[torch.nn.Module]:
...
def patch_pixart_transformer_block(block_class):
