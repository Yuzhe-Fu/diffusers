...
class JointTransformerBlock(nn.Module):
    ...
    def forward(
        self,
        hidden_states: torch.FloatTensor, # image features [batch_size, seq_len, hidden_dim]
        encoder_hidden_states: torch.FloatTensor, # text features [batch_size, seq_len, hidden_dim]
        temb: torch.FloatTensor, # time embeddings [batch_size, hidden_dim]
